...
#     pipeline_parallelism.py "$@" #--minibatch 256 --model "google/vit-base-patch16-224-in21k" \

mpirun python pipeline_parallelism.py "$@" #--minibatch 256 --model "google/vit-base-patch16-224-in21k" \
